...
Chat Workspace เป็นเว็บแอปสำหรับสนทนากับโมเดล AI แบบ streaming พร้อมพื้นที่แก้ไขโค้ดในหน้าเดียวกัน เมื่อโมเดลตอบกลับด้วย fenced code block ระบบจะแยกโค้ดออกจากข้อความ บันทึกเป็นไฟล์แบบมี revision และเปิดไฟล์นั้นใน Monaco Editor โดยอัตโนมัติ
